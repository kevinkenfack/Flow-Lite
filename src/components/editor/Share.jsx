    ...
    <div className='relative' ref={sharePanelRef}>
      ...
      <div  className='absolute right-0 top-12 bg-white border rounded-md p-4'>
        ...
        <div className='mt-2'>
          ...
          <div className='text-xs px-2 p-1 bg-yellow-50 border border-yellow-400 rounded-md mt-2 font-medium'>
            This demo app uses local storage, so the share link will not function.
          </div>
        </div>
      </div>
    } 
