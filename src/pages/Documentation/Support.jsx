  ...
  return (
    <div>
        <article>
          ...
          <p><a class="text-blue-600 font-semibold" target="_blank" href="https://codecanyon.net/item/flowlite-user-flow-builder/55748214/support">Codecanyon - FlowLite Support</a></p>
          <br />
          <p>
